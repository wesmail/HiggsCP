...
# framework imports
from data_handling import HiggsMLPDataset
from models import SimpleMLP


class MLP(pl.LightningModule):
    def __init__(self, module, batch_size, num_classes=3):
        super().__init__()
...
def main(argv):
    ...
    parser.add_argument('-n', type=int, required=False, help='binary or multi-class classification', default=3)
    ...
    dataset = HiggsMLPDataset(indata=df, shuffle=True)
    ...
    # ONLY needed if you have tensor cores
    ...
    model = MLP(module=MODEL, batch_size=BATCH_SIZE)
